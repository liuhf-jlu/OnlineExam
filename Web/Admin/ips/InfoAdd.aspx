<%@ Page Language="C#"   AutoEventWireup="true" CodeBehind="InfoAdd.aspx.cs" Inherits="Web.Admin.ips.InfoAdd" %>
...
<body>
    <div id="container">
        ...
        <div id="navigation">
    		<table>
    			<tr>
    				<td class="pagePostion">&nbsp;&nbsp;当前位置：信息发布</td>
    			</tr>
    		</table>
        </div>
        <!-- 中间区 -->
        <div id="middle">
            ...
            <!—- 内容区 -->
	        <div id="content">
                <form id="Form1" name="infoAddForm" runat="server" >
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvEndDate" runat="server" ControlToValidate="txtEndDate"
                                    Display="Dynamic" ErrorMessage="结束日期不能空" ForeColor="Red" 
                                    ValidationGroup="vgInfo">*</asp:RequiredFieldValidator>
                            </td>
                            <td>信息类别</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="7" style="text-align:center;">
                                <asp:Button ID="btnSaveDraft" runat="server" 
                                    ...
                                    CssClass="button" OnClick="btnSaveDraft_Click" Text="保存草稿" />&nbsp;
                                <asp:Button ID="btnSubmitPublish" runat="server" 
                                    CausesValidation="True" ValidationGroup="vgInfo" 
                                    CssClass="button" OnClick="btnSubmitPublish_Click" Text="提交发布" />&nbsp;                                
                            </td>
                        </tr>                      
                    </table>
                </form>
